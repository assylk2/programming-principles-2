...
class MickeyClock:
    def __init__(self, screen_width, screen_height):
        ...
        self.mickey_body = pygame.transform.scale(self.mickey_body, (435, 535)) 
        ...
        self.min_hand_orig = pygame.transform.scale(self.min_hand_orig, (210, 270)) # Adjust to fit your clock
        
        self.sec_hand_orig = pygame.image.load(os.path.join(img_dir, "hand_left_centered.png")).convert_alpha()
        self.sec_hand_orig = pygame.transform.scale(self.sec_hand_orig, (210, 250)) # Adjust to fit your clock
